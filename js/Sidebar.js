...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	...
	var fns = [
		...
		this.createVertexTemplateEntryWithId('BOM','text;html=1;strokeColor=#c0c0c0;fillColor=#ffffff;overflow=fill;rounded=0;', 450, 100, '<table border="1" width="100%" height="100%" cellpadding="4" style="width:100%;height:100%;border-collapse:collapse;">' +
 ...
 * Creates a drop handler for inserting the given cells.
 */
Sidebar.prototype.createVertexTemplateEntryWithId = function(id, style, width, height, value, title, showLabel, showTitle, tags)
{
	tags = (tags != null && tags.length > 0) ? tags : title.toLowerCase();
	
	return this.addEntry(tags, mxUtils.bind(this, function()
 	{
 		return this.createVertexTemplateWithId(id, style, width, height, value, title, showLabel, showTitle);
 	}));
}
 ...
 * Creates a drop handler for inserting the given cells.
 */
Sidebar.prototype.createVertexTemplateWithId = function(id, style, width, height, value, title, showLabel, showTitle, allowCellsInserted)
{
