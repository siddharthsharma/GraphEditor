...
EditorUi = function(editor, container, lightbox)
{
	...
	this.bom = new BillOfMaterial(graph);
...
{
	//geMenubarContainer
	this.menubarContainer = this.createDiv('navbar navbar-expand-lg navbar-default');
...
EditorUi.prototype.createUl = function(className)
{
...
EditorUi.prototype.createUi = function()
{
	//geMenubar
	// Creates menubar
	this.menubar = (this.editor.chromeless) ? null : this.menus.createMenubar(this.createUl('navbar-nav'));
